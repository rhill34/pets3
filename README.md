...
Take turns completing the steps below. After each step, add-commit-push your code to GitHub. Before beginning the next step, do a git pull and then Download to local.
